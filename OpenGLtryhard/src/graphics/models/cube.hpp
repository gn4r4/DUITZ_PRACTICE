...
public:
	...
	void init() {
		...
		Texture diffuse("assets/image1.jpg", "material.diffuse");
        diffuse.load();
        Texture specular("assets/image2.jpg", "material.specular");
        specular.load();

		meshes.push_back(Mesh(Vertex::genList(vertices, noVertices), indices, {diffuse, specular}));
